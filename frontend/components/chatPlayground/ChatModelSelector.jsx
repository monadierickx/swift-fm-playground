...
import { models } from '../../helpers/modelData'; // FIXME: chatModelData

export default function ChatModelSelector({ model, onModelChange }) {
    ...
    return (
        <div className="w-64 mb-4">
            <div className="relative w-full">
                ...
                {isOpen && (
                    <div className="absolute right-0 mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 p-1 text-sm w-64 z-50">
